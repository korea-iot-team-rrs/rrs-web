...
export const TODO_GET_BY_DATE_PATH = (day: string) => `/todos/todos?day=${day}`;
...
export const RESERVATION_PUT_STATUS_PATH = (reservationId:number) => `/reservations/${reservationId}/status`;
export const RESERVATION_GET_AVAILABLE_PROVIDER = `/reservations/available-providers`;
export const RESERVATION_HAS_REVIEW_PATH  = (reservationId:number) => `/api/v1/reservations/${reservationId}/review`;

// Review
export const REVIEW_POST_PATH = '/reviews';
export const REVIEW_GET_BY_PROVIDER_PATH = (providerId:number) =>`/reviews/providers/${providerId}`;
export const REVIEW_GET_BY_RESERVATION_PATH = (reservationId:number) => `/reviews/reservations/${reservationId}`;
export const REVIEW_GET_AVG_PATH = (providerId:number) => `/reviews/providers/${providerId}/average`;
export const REVIEW_PUT_PATH = (reservationId:number) => `/reviews/reservations/${reservationId}`;
export const REVIEW_DELETE_PATH = (reviewId:number) => `/reviews/${reviewId}`;
export const REVIEW_GET_LATEST_REVIEW = (providerId:number) => `/reviews/providers/${providerId}/latest`;
...
export const CUSTOMER_SUPPORT_GET_PATH = (customerSupportId:number) => `/customer-supports/${customerSupportId}/me`;
