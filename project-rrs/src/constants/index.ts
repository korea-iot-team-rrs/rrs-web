...
// CustomerSupport
export const CUSTOMER_SUPPORT_CREATE_PATH = '/inquiry-and-report/write';
export const CUSTOMER_SUPPORT_GET_ALL_PATH = '/inquiry-and-report';
export const CUSTOMER_SUPPORT_GET_PATH = (customerSupportId:number) => `/inquiry-and-report/${customerSupportId}`;
export const CUSTOMER_SUPPORT_PUT_PATH = (customerSupportId:number) => `/inquiry-and-report/${customerSupportId}`;
export const CUSTOMER_SUPPORT_DELETE_PATH  = (customerSupportId:number) => `/inquiry-and-report/${customerSupportId}`;
