...
const DahyeAwesomeSite: React.FC = () => {
  return (
          ...
          <div className="container-large page-padding">
            <div className="spacer-xl-start spacer-xl-end">
              <div className="w-layout-grid bento-grid">
                ...
                >
                  <img src={dogImgsrc} alt="" className="bento-person-image" />
                </div>
                <div
                ...
                >
                  ...
                  <div className="social-icons1_component">
                    ...
                    <br />
                    <a href="/petDiary" className="social-icons1_link w-inline-block">
                    <CiMemoPad  size={80}/>
                    댕수첩
                    </a>
                    <br />
                    <a href="/petRoad" className="social-icons1_link w-inline-block">
                ...
                >
                  <img src={dogIllust03} alt="" className="bento-mood-image" />
                </div>
              </div>
            </div>
          </div>
...
export default DahyeAwesomeSite;
